...
Namespace CustomDrawExample
	Partial Public Class Form1
		...
		Public Sub New()
			...
			spreadsheetControl1.Options.Behavior.Column.Delete = DevExpress.XtraSpreadsheet.DocumentCapability.Disabled
			spreadsheetControl1.Options.Behavior.Column.Insert = DevExpress.XtraSpreadsheet.DocumentCapability.Disabled
		...
		Private Sub spreadsheetControl1_CustomDrawColumnHeader(ByVal sender As Object, ByVal e As DevExpress.XtraSpreadsheet.CustomDrawColumnHeaderEventArgs)
			e.Handled = True
		...
		Private Sub spreadsheetControl1_CustomDrawColumnHeaderBackground(ByVal sender As Object, ByVal e As DevExpress.XtraSpreadsheet.CustomDrawColumnHeaderBackgroundEventArgs)
			e.Handled = True
		...
		Private Sub spreadsheetControl1_CustomDrawRowHeader(ByVal sender As Object, ByVal e As DevExpress.XtraSpreadsheet.CustomDrawRowHeaderEventArgs)
			e.Handled = True
		...
		Private Sub spreadsheetControl1_CustomDrawRowHeaderBackground(ByVal sender As Object, ByVal e As DevExpress.XtraSpreadsheet.CustomDrawRowHeaderBackgroundEventArgs)
			e.Handled = True
		...
		Private Sub spreadsheetControl1_CustomDrawCell(ByVal sender As Object, ByVal e As DevExpress.XtraSpreadsheet.CustomDrawCellEventArgs)
			If e.Cell.RowIndex = 0 OrElse e.Cell.RowIndex >= 3 Then
				Dim headingFont As New Font("Times New Roman", e.Font.Size)
				...
				Dim rank As Integer = CInt(Fix(spreadsheetControl1.Document.Evaluate(formula).NumericValue))
		...
		Private Sub spreadsheetControl1_CustomDrawCellBackground(ByVal sender As Object, ByVal e As DevExpress.XtraSpreadsheet.CustomDrawCellBackgroundEventArgs)
