...
'INSTANT VB NOTE: The variable text was renamed since Visual Basic does not handle local variables named the same as class members well:
			...
			If text_Conflict <> String.Empty Then
				...
				e.Graphics.DrawString(text_Conflict, headingFont, e.Cache.GetSolidBrush(foreColor_Conflict), textBounds, formatHeaderText)
			End If
		End Sub
...
'INSTANT VB NOTE: The variable font was renamed since Visual Basic does not handle local variables named the same as class members well:
				Dim font_Conflict As System.Drawing.Font = New Font(e.Font.FontFamily, e.Font.Size, FontStyle.Bold)
				Dim textBounds As Rectangle = e.Bounds
'INSTANT VB NOTE: The variable text was renamed since Visual Basic does not handle local variables named the same as class members well:
				...
				formatHeaderText.LineAlignment = StringAlignment.Center
				formatHeaderText.Alignment = StringAlignment.Center
				e.Graphics.DrawString(text_Conflict, font_Conflict, e.Cache.GetSolidBrush(Color.Red), textBounds, formatHeaderText)
			Else
				'e.DrawDefault();
			End If
		End Sub
